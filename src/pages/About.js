...
function About() {
  return (
    <div className="relative bg-[#f5e6d3] min-h-screen">
      <main className="container mx-auto px-4 pt-36 sm:pt-16 py-16">
        {/* About Us Card */}
        <section className="max-w-5xl mx-auto bg-white rounded-xl shadow-xl p-6 sm:p-10">
          <h1 className="text-3xl sm:text-5xl font-bold text-center mb-4 sm:mb-10">
            About Us
          </h1>
          <p className="text-center text-base sm:text-lg text-gray-800 mb-4 sm:mb-8">
            We are surpassing your expectations.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-12 items-center mb-6 sm:mb-12">
            {/* Image */}
            <div>
              <img
                src="cafe.jpg"
                alt="Cafe"
                className="h-60 sm:h-80 w-full object-cover rounded-lg shadow-lg"
              />
            </div>
            {/* Text */}
            <div className="space-y-2 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-semibold text-[#8b5e34]">
        ...
        {/* Hours and Map Card */}
        <section className="max-w-5xl mx-auto bg-white rounded-xl shadow-xl p-6 sm:p-10 mt-8 sm:mt-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-12">
            {/* Hours & Contact */}
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2 text-[#8b5e34]">
                  Hours
                </h3>
                <ul className="text-sm sm:text-lg text-gray-700 space-y-1">
              ...
              <div>
                ...
                <p className="text-sm sm:text-lg text-gray-700 mb-2 sm:mb-3">
                  Reach out to us anytime.
                </p>
                <a
                  href="/contact"
                  className="inline-block bg-[#8b5e34] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-center hover:bg-[#6e3f1b] transition"
                >
                  Contact Us
                </a>
              </div>
